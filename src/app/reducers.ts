...
import { IGetAllIssuesAction, IIssueAction, ACTION, IChangePageAction } from './actions';
...
function goToPage(state: number = initialState.pageNumber, action: IChangePageAction): number {
  switch (action.type) {
